...
const translations = {
  ...
  en: {
    ...
    navRescue: "Safe Shelters & SOS",
    navRakshak: "🛡️ Rakshak Portal",
  ...
  hi: {
    ...
    navRescue: "सुरक्षित आश्रय व एसओएस",
    navRakshak: "🛡️ रक्षक बचाव पोर्टल",
  ...
  pa: {
    ...
    navMap: "ਨਕਸ਼ਾ",
    navRescue: "ਸੁਰੱਖਿਅਤ ਸ਼ੈਲਟਰ ਤੇ ਐਸਓਐਸ",
    navRakshak: "🛡️ ਰੱਖਿਅਕ ਕਮਾਂਡ",
    navGuide: "ਫੋਟੋ ਗਾਈਡ",
  ...
  doi: {
    ...
    navMap: "नक्शा",
    navRescue: "सुरक्खत शरण ते एसओएस",
    navRakshak: "🛡️ रक्षक पोर्टल",
  ...
  gbm: {
    ...
    navHome: "खतरा जांच",
    navMap: "नक्शा",
    navRescue: "सुरक्षित शरण व एसओएस",
    navRakshak: "🛡️ रक्षक बचाव केंद्र",
    navGuide: "फोटो गाइड व लक्षण",
  ...
  him: {
    ...
    navHome: "जोखिम जांच",
    navMap: "नक्शा",
    navRescue: "सुरक्षित शेल्टर व एसओएस",
    navRakshak: "🛡️ रक्षक कमान",
    navGuide: "फोटो गाइड",
  ...
  ne: {
    ...
    navMap: "नक्शा",
    navRescue: "सुरक्षित आश्रय र एसओएस",
    navRakshak: "🛡️ रक्षक उद्धार पोर्टल",
  ...
  ur: {
    ...
    navHome: "خطرہ جانچیں",
    navMap: "نقشہ",
    navRescue: "محفوظ پناہ گاہیں اور ایس او ایس",
    navRakshak: "🛡️ محافظ ریسکیو پورٹل",
    navGuide: "فوٹو گائیڈ",
  ...
  bn: {
    ...
    navMap: "মানচিত্র",
    navRescue: "নিরাপদ আশ্রয় ও এসওএস",
    navRakshak: "🛡️ রক্ষক রেসকিউ পোর্টাল",
